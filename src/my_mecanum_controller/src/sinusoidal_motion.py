...
AMPLITUDE = 1  # Amplitude of the sinusoid (meters)
FREQUENCY = 1  # Frequency of the sinusoid (Hz)
SPEED = 0.5  # Linear speed in the x-direction (m/s)
...
def move_in_sin_wave():
    ...
    while not rospy.is_shutdown():
        ...
        twist.linear.y = 2*AMPLITUDE*math.pi*FREQUENCY*SPEED*math.cos(2 * math.pi * FREQUENCY * SPEED*t)  # Sinusoidal y velocity
